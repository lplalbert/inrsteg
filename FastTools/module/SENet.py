...
class SENet(nn.Module):
	...
	out_channels 必须是r=8的倍数
	"""
	def __init__(self, in_channels, out_channels, blocks=1, block_type="BottleneckBlock", r=8, groups=1, dilation=1, drop_rate=1, se=True):
