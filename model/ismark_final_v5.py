...
# 需要在输入的数据中，添加尺度标签，可用一个linear embedding来学习
...
class INRMark(EngineModel):
    def __init__(self, args):
        ...
        self.decoder = nn.Sequential(
            # ImageNormalizer(),
            decoder,
            MLP(48, self.msg_len, hidden_dim=128, num_hidden_layers=1, norm='none', act='relu'),
        )
        ...
        self.inr = ResMLP(self.level_dim * self.level_num + self.diff_coords_dim + self.feat_channel + 3, 3, num_layers=6, hidden_dim=256, norm='bn', activation='relu')
